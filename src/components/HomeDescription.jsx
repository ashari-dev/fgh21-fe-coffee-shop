...
function HomeComponent() {
  return (
    <div className="flex w-full h-1/2">
      <div className="flex flex-1 flex-col md:max-w-[50%] h-full gap-6 md:pt-14 px-5 md:pl-36 md:pr-16">
      ...
      <div className="bg-[#FF8906] md:flex md:w-[100vh] w-full flex-1 md:h-[50vh] hidden"></div>
    </div>
  );
}
