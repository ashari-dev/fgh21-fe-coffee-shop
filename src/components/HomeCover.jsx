    ...
    <>
      <div className="flex h-screen">
          ...
          <div className="flex h-screen justify-center flex-col gap-6 px-5 md:px-32">
            ...
            <div className="hidden md:block">
              <button
                ...
                className="bg-[#FF8906] w-36 h-12 rounded"
              >
                Get Started
              </button>
            </div>
            <div className="flex justify-between items-center md:hidden">
              <div>
                <button className="bg-[#FF8906] w-36 h-12 rounded">
                  Get Started
                </button>
              </div>
              <div>
                <button className="bg-[#FF8906] p-4 rounded-full">
                  <FaCommentDots className="text-2xl"></FaCommentDots>
                </button>
              </div>
            </div>
            <div className="text-[#FF8906] flex gap-10 justify-between md:justify-normal">
              <div>
                <div className="md:text-5xl text-2xl">90+</div>
                <div>Staff</div>
              </div>
              <div className="border h-20"></div>
              <div>
                <div className="md:text-5xl text-2xl">30+</div>
                <div>Stores</div>
              </div>
              <div className="border h-20"></div>
              <div>
                <div className="md:text-5xl text-2xl">300+</div>
                <div>Costumers</div>
              </div>
            </div>
          </div>
        ...
        <div className="hidden md:block md:flex-1">
          ...
          <button className="bg-[#FF8906] p-7 rounded-full absolute bottom-24 right-36">
