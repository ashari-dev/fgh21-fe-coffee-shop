...
import { FaLocationDot, FaPhone, FaRegCreditCard, FaRegUser, FaTruck } from "react-icons/fa6";
            ...
            <div className="absolute bg-[#00000099] w-full h-screen flex justify-end">
                <div className=" bg-white p-5 flex flex-col w-1/3">
                    <div className="flex justify-between mb-2">
                        <h1 className="font-semibold text-2xl">Order  #12354-09893</h1>
                        <button
                            onClick={() => {
                            ...
                            <div className="">
                                <div className="flex items-center p-4 gap-2 border-b-2">
                                    ...
                                    <div className="flex w-full justify-between">
                                        <div className="font-medium text-xs text-[#4F5665]">Full Name</div>
                                        <div className="text-[#0B132A] font-bold text-xs">Ghaluh Wizard Anggoro</div>
                                    </div>
                                </div>
                                <div className="flex items-center p-4 gap-2 border-b-2">
                                    <FaLocationDot className="text-[#4F5665]"/>
                                    <div className="flex w-full justify-between">
                                        <div className="font-medium text-xs text-[#4F5665]">Address</div>
                                        <div className="text-[#0B132A] font-bold text-xs">Griya bandung indah</div>
                                    </div>
                                </div>
                                <div className="flex items-center p-4 gap-2 border-b-2">
                                    <FaPhone className="text-[#4F5665]"/>
                                    <div className="flex w-full justify-between">
                                        <div className="font-medium text-xs text-[#4F5665]">Phone</div>
                                        <div className="text-[#0B132A] font-bold text-xs">082116304338</div>
                                    </div>
                                </div>
                                <div className="flex items-center p-4 gap-2 border-b-2">
                                    <FaRegCreditCard className="text-[#4F5665]"/>
                                    <div className="flex w-full justify-between">
                                        <div className="font-medium text-xs text-[#4F5665]">Payment Method</div>
                                ...
                                <div className="flex items-center p-4 gap-2 border-b-2">
                                    ...
                                    <div className="flex w-full justify-between">
                                        <div className="font-medium text-xs text-[#4F5665]">Shipping</div>
                                        <div className="text-[#0B132A] font-bold text-xs">Dine In</div>
                                    </div>
                                </div>
                                <div className="flex items-center p-3 gap-2 border-b-2">
                                    <FcProcess className="text-[#4F5665]"/>
                                    <div className="flex w-full justify-between items-center">
                                        <div className="font-medium text-xs text-[#4F5665]">status</div>
                                        <select className="bg-gray-400/20 p-2 text-xs rounded-lg font-medium">
                                ...
                                <div className="flex items-center justify-between p-4 gap-2">
                                    <div className="font-medium text-xs text-[#4F5665]">Total Transaksi</div>
                                    <div className="text-[#FF8906] font-bold text-xs">IDR 40.000</div>
                                </div>
                            </div>
                        <div className="">
                            <div className="mb-5">
                            ...
                            <div>
                                <button className="bg-orange-500 w-full h-10 font-medium rounded-lg">Update</button>
                            </div>
                        </div>          
                    </div>
                </div>
