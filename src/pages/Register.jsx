...
function Register() {
  ...
  return (
        <div className="flex w-full h-screen items-center gap-16 md:pr-32 md:p-0 p-5">
            ...
            <form className="flex flex-col justify-center gap-6 md:w-3/4 w-full" onSubmit={formik.handleSubmit}>
                <Logo/>
                ...
                <label htmlFor="name" className="flex flex-col gap-1 w-full justify-center">
                    ...
                    <div className="flex items-center border-2 p-3 rounded-lg gap-2 text-[#4F5665]">
                        <FaRegUser />
                        <input type="text" name="name" id="name" placeholder="Enter Your Full Name" onChange={handleForm} className="w-full outline-none"/>
                    </div>
                </label>
                <label htmlFor="email" className="flex flex-col gap-1 w-full justify-center">
                    ...
                    <div className="flex items-center border-2 p-3 rounded-lg gap-2 text-[#4F5665]">
                        <FaRegEnvelope />
                        <input type="email" name="email" id="email" placeholder="Enter Your Email" onChange={handleForm} className="w-full outline-none"/>
                    </div>
                </label>
                <label htmlFor="password" className="flex flex-col gap-1 w-full justify-center">
                    ...
                    <div className="flex items-center border-2 p-3 rounded-lg gap-2 text-[#4F5665]">
                        <FaKey />
                        <input type={pass} name="password" id="password" placeholder="Enter Your Password" onChange={handleForm} className="w-full outline-none"/>
                ...
                <label htmlFor="confirmpassword" className="flex flex-col gap-1 w-full justify-center">
                    ...
                    <div className="flex items-center border-2 p-3 rounded-lg gap-2 text-[#4F5665]">
                        <FaKey />
                        <input type={confPass} name="confirmpassword" id="confirmpassword" placeholder="Enter Your Password Again" onChange={handleForm} className="w-full outline-none"/>
